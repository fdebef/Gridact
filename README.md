...
{line_id: {
  ...
  ####cellRender
  Type: function | string \<option><br>
  If undefined, the cell is rendered with value provided in data.<br>
  If string is provided, the string is returned.<br>
  ...
  *Example:*<br>
  ...
  ####filterEditChar
  Type: RegExp | function \<optional><br>
